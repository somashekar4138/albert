!(function (e) {
    ...
    var r = {
      ...
      i = (function () {
        ...
        return (
          ...
          (e.getRequestedAmountRange = function (t) {
            var n = "",
              r = e.get("requestedAmountRangeValues");
            return r && r[t] && (n = r[t]), n;
          }),
          e
        );
      })();
    ...
    (function (e) {
      ...
      var f = (function (e) {
          function t() {
            var t;
            return (
              ((t = e.call(this) || this).classPrefix = "PushManager"),
              (t.classes = {
                PushManagerOur: d,
                PushManageruPush: g,
                PushManagerSendPulse: h,
              }),
              t
            );
          }
          ...
          return (
            (n.get = function (e, t) {
              return (
                void 0 === t && (t = {}),
                void 0 !== this.objects[e] ||
                  (this.objects[e] = this.create(e, t)),
                this.objects[e]
              );
            }),
            (n.run = function (e) {
              void 0 === e && (e = null);
              var t = i.a.get("pushNotification") || {},
                n = s(
                  s(
                    {},
                    {
                      manager: "Our",
                      showOnlyOnProcessing: !1,
                      active: !0,
                      options: { leadId: e },
                    }
                  ),
              ...
              if (n.active) {
                var r = Object(o.e)("apply") || Object(o.e)("account");
                if (!n.showOnlyOnProcessing || r)
                  this.get(n.manager, n.options).run();
              }
            }),
            t
          );
        ...
        p = (function () {
              ...
              s(
                {},
                {
                  ...
                  applicationServerKey:
                    "BIsROLKgUJQ5H-rhwiVaOP4Uf8IjIP9lDptziLMCiF9f5ol-MsutsxhCsCriWngFMp1QD-6EqpUenk2GjEnMr6Q",
          ...
          return (
            (e.prototype.urlBase64ToUint8Array = function (e) {
              for (
        ...
        d = (function (t) {
          ...
          return (
                  ...
                  ? "showNotification" in ServiceWorkerRegistration.prototype
                    ? "denied" !== Notification.permission
                      ? (navigator.serviceWorker
                          .register(this.options.serviceWorkerUrl)
                          .then(function () {
                            console.log(
            ...
            (r.sendToServer = function (t) {
              if (t) {
                var r = t.getKey("p256dh"),
                  o = t.getKey("auth"),
                ...
                n.needUpdate(s) &&
                  e.ajax({
                    ...
                    type: "POST",
                    dataType: "json",
                    url: i.a.get("pushSubscribeUrl"),
                    data: s,
                    success: function (e) {
                      e.result &&
                        "success" === e.result &&
                        n.saveSubscription(s);
                    },
                  });
              }
            }),
            (n.needUpdate = function (e) {
              var t = localStorage.getItem("subscription");
              return !t || JSON.stringify(e) !== t;
            }),
            (n.saveSubscription = function (e) {
              localStorage.setItem("subscription", JSON.stringify(e));
            }),
            n
          );
        })(p),
        h = (function (e) {
          ...
          return (
            ...
            (t.prototype.run = function () {
              var e = location.host.replace(/[\.]+$/g, "");
              if (this.options.src[e]) {
                var t = document.createElement("script");
                (t.src = this.options.src[e]),
        ...
        g = (function (t) {
          ...
          return (
            ...
            (n.prototype.run = function () {
              var t = this.options.uPushApiKey || null;
              if (t) {
                var n = document.createElement("link");
                n.setAttribute("rel", "manifest"),
                  n.setAttribute("href", this.options.manifestUrl),
                  document.getElementsByTagName("head")[0].appendChild(n),
                  e
                    .getScript("https://sdk.upush.co/upush.js")
                    .then(function () {
                      upushRequest(t);
                    });
              } else console.error("uPushApiKey not provided");
            }),
            n
          );
        })(p);
  ...
  286: function (e, t, n) {
    ...
    var a = (function () {
      function e() {
        (this.objects = {}), (this.classPrefix = ""), (this.classes = {});
      }
      var t = e.prototype;
      return (
        (t.get = function () {
          var e = Array.prototype.slice.call(arguments),
            t = Array.prototype.shift.apply(e);
          return (
            void 0 !== this.objects[t] || (this.objects[t] = this.create(t, e)),
            this.objects[t]
          );
        }),
        (t.create = function (e) {
          var t = this.classPrefix + e;
          if (void 0 === this.classes[t]) throw "Unknown class: " + t;
          for (
    ...
    (function (e) {
        ...
        for (
          var r = function (r, i) {
              ...
              o.live || void 0 === o.live
                ? e(document).on(o.type, o.target, a.bind(n))
                : e(o.target).on(o.type, a.bind(n));
            },
            i = 0,
            o = t.length;
          i < o;
      ...
      function i() {
        var e,
          ...
          r = {};
        try {
          for (e in (r = decodeURIComponent(
            window.location.search.replace(/\+/g, "%20")
          )
            .substr(1)
            .split("&"))) {
            if (!((t = r[e].split("="))[0].length < 1))
              n[t.shift()] = t.join("=");
          }
        } catch (e) {
          console.error(e);
     ...
     */ !(function (t, n) {
      ...
      var j =
        ...
        (function (e) {
          ...
          try {
            q.apply((D = L.call(w.childNodes)), w.childNodes),
          ...
          function Ce(e, t, n, r, i, o) {
            return (
              ...
              ce(function (o, a, s, u) {
                ...
                } else (y = Te(y === a ? y.splice(h, y.length) : y)), i ? i(null, a, y, u) : q.apply(a, y);
              })
            );
          }
          function Se(e) {
          ...
          function (e, t) {
            C.fn[e] = function (n, r) {
              ...
              return (
                ...
                this.length > 1 &&
                  (H[e] || C.uniqueSort(i), L.test(e) && i.reverse()),
                this.pushStack(i)
              );
            };
          }
      ...
      function Te(e, t, n, r, i) {
        ...
        for (f.textContent = "", d = 0; (o = p[d++]); )
          if (r && C.inArray(o, r) > -1) i && i.push(o);
            ...
            ((c = ae(o)), (a = be(f.appendChild(o), "script")), c && xe(a), n)
          )
      ...
      function Me(e, t, n, r) {
        ...
        if (
          ...
          for (s = (a = C.map(be(i, "script"), qe)).length; f < p; f++)
            (c = i),
              f !== d &&
                ((c = C.clone(c, !0, !0)), s && C.merge(a, be(c, "script"))),
              n.call(e[f], c, f);
          if (s)
            for (
              l = a[a.length - 1].ownerDocument, C.map(a, Le), f = 0;
              f < s;
              f++
            )
              (c = a[f]),
                ye.test(c.type || "") &&
                  ...
                  (c.src && "module" !== (c.type || "").toLowerCase()
                    ...
                    : w(c.textContent.replace(Oe, ""), c, l));
        }
        return e;
      }
      function Ie(e, t, n) {
            ...
            if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
              ...
              d))
                u ||
                  ...
                  g && pe([e], !0),
                  p.done(function () {
                    for (r in (g || pe([e]), Y.remove(e, "fxshow"), d))
                      C.style(e, r, d[r]);
                  })),
                  (u = ft(g ? v[r] : 0, r, p)),
                  r in v ||
          ...
          ajax: function (e, t) {
            ...
            function j(e, t, a, u) {
              ...
              c ||
                ...
                (S.status = e),
                (S.statusText = (t || T) + ""),
                f ? v.resolveWith(h, [p, T, S]) : v.rejectWith(h, [S, T, b]),
                S.statusCode(m),
                (m = void 0),
                l &&
                  g.trigger(f ? "ajaxSuccess" : "ajaxError", [S, d, f ? p : b]),
                y.fireWith(h, [S, T]),
                l &&
      ...
      C.ajaxSetup({
        ...
        C.each(["top", "left"], function (e, t) {
          C.cssHooks[t] = Xe(v.pixelPosition, function (e, n) {
            if (n)
              return (n = ze(e, t)), _e.test(n) ? C(e).position()[t] + "px" : n;
          });
        }),
      ...
      return (
        (C.noConflict = function (e) {
          return (
            n.$ === C && (n.$ = Yt), e && n.jQuery === C && (n.jQuery = Qt), C
          );
        }),
  ...
  608: function (e, t, n) {
    ...
    var r = n(285);
    function i(e) {
      void 0 === e && (e = null), new r.a().run(e || null);
    }
    if (window.hasOwnProperty("_lg_notifications_"))
      try {
        window._lg_notifications_.forEach(function (e) {
          return i(e);
        });
      } finally {
        window._lg_notifications_ = [];
      }
    window.collectNotificationsFacade = i;
  },
});
